...
@Composable
fun SimulatorScreen(){
    Simulation(wallet = 120.00, netWorth = 130.00, bonds = BondOption("US Treasury Bond", 24.50, 3.5))
}
...
@Composable
fun Simulation(wallet: Double, netWorth: Double, bonds: BondOption) {
...
data class SimData(val title:String, val intRate: Double, val date: String)
